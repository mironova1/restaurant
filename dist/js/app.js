...
***************************************************************************** */
    ...
    class ContinuousTailDetails {
        constructor() {
            ...
            let from = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
    ...
    class Masked {
        ...
        totalInputPositions() {
            let fromPos = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
            let toPos = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length;
        ...
        _appendChar(ch) {
            let flags = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        ...
        append(str, flags, tail) {
            ...
            if ((true === this.eager || "append" === this.eager) && null !== flags && void 0 !== flags && flags.input && str) details.aggregate(this._appendEager());
            return details;
        }
        remove() {
            let fromPos = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
        ...
        splice(start, deleteCount, inserted, removeDirection) {
            let flags = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {
                input: true
            };
    ...
    class PatternInputDefinition {
        ...
        nearestInputPos(cursorPos) {
            let direction = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : DIRECTION.NONE;
            const minPos = 0;
    ...
    class PatternFixedDefinition {
        ...
        remove() {
            let fromPos = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
            let toPos = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this._value.length;
        ...
        extractInput() {
            let fromPos = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
            let toPos = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this._value.length;
            let flags = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
    ...
    class ChunksTailDetails {
        constructor() {
            let chunks = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
            let from = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
            this.chunks = chunks;
            this.from = from;
        }
    ...
    class MaskedPattern extends Masked {
        ...
        _rebuildMask() {
            ...
            for (let i = 0; i < pattern.length; ++i) {
                ...
                const maskOpts = null !== (_defs$char = defs[char]) && void 0 !== _defs$char && _defs$char.mask && !((null === (_defs$char2 = defs[char]) || void 0 === _defs$char2 ? void 0 : _defs$char2.mask.prototype) instanceof IMask.Masked) ? defs[char] : {
                    mask: defs[char]
                };
        ...
        _appendEager() {
            ...
            const details = new ChangeDetails;
            let startBlockIndex = null === (_this$_mapPosToBlock = this._mapPosToBlock(this.value.length)) || void 0 === _this$_mapPosToBlock ? void 0 : _this$_mapPosToBlock.index;
        ...
        _appendPlaceholder(toBlockIndex) {
            ...
            this._blocks.slice(startBlockIndex, endBlockIndex).forEach((b => {
                if (!b.lazy || null != toBlockIndex) {
                    const args = null != b._blocks ? [ b._blocks.length ] : [];
    ...
    class MaskedDate extends MaskedPattern {
        ...
        doValidate() {
            ...
            return super.doValidate(...arguments) && (!this.isComplete || this.isDateExist(this.value) && null != date && (null == this.min || this.min <= date) && (null == this.max || date <= this.max));
        }
        isDateExist(str) {
    ...
    class MaskedNumber extends Masked {
        ...
        _separatorsCount(to) {
            let extendOnSeparators = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : false;
            let count = 0;
        ...
        _separatorsCountFromSlice() {
            let slice = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._value;
    ...
    class MaskedDynamic extends Masked {
        ...
        _applyDispatch() {
            let appended = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
            let flags = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            let tail = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "";
            ...
            const details = new ChangeDetails;
            const prevMaskState = null === prevMask || void 0 === prevMask ? void 0 : prevMask.state;
        ...
        get state() {
            ...
            return Object.assign({}, super.state, {
                ...
                currentMask: null === (_this$currentMask4 = this.currentMask) || void 0 === _this$currentMask4 ? void 0 : _this$currentMask4.state
            });
        }
        set state(state) {
        ...
        typedValueEquals(value) {
            ...
            return Boolean(null === (_this$currentMask5 = this.currentMask) || void 0 === _this$currentMask5 ? void 0 : _this$currentMask5.typedValueEquals(value));
        }
    }
    ...
    function createPipe(mask) {
        let from = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : PIPE_TYPE.MASKED;
        let to = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : PIPE_TYPE.MASKED;
